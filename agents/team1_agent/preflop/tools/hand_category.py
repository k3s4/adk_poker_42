...
class HandCategory(Enum):
    ...
    WHITE = "K7s, K6s, K5s, K4s, K3s, K2s, Q8s, Q7s, Q6s, J8s, J7s, 97s, 87s, 76s, 65s, K9o, Q9o, J9o, T9o, A8o, K8o, A7o, A6o, A5o, A4o, A3o, A2o, T8o, 98o, Q5s, Q4s, Q3s, Q2s, J6s, T7, 96s, 86s, 75s, 64s, 54s" # 40 hands
    GRAY = "それ以外"
